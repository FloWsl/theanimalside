...
const AnimalPhotoGallery: React.FC<AnimalPhotoGalleryProps> = ({ animalTypes }) => {
  ...
  return (
    <div className="space-y-0">
      {/* Header */}
      <div className="bg-gradient-to-br from-sage-green/5 to-warm-sunset/5 rounded-3xl p-6 sm:p-8 shadow-nature-xl border border-sage-green/10">
        <div className="text-center space-y-4">
          <h2 className="text-section text-deep-forest">Wildlife You’ll Work With</h2>
        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory space-x-3 md:space-x-4 py-6 scrollbar-hide md:grid md:grid-cols-4 md:gap-4 md:space-x-0">
